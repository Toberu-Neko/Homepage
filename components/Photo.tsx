...
const Photo = () => {
  return (
    <div className="w-full h-full relative">
        <motion.div initial={{opacity: 0}} animate={{opacity:1 , transition: {delay:1.2, duration: 0.4, ease: "easeIn"}}}>
          {/*Image*/}
          ...
          {/* circle */}
          <motion.svg className="w-[300px] xl:w-[456px] h-[300px] xl:h-[456px]" 
          fill="transparent"
          viewBox="0 0 506 506"
